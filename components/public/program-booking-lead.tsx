...
import { ProgramBookingScheduler } from "@/components/public/program-booking-scheduler";
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 sm:pb-14">
        ...
        <div className="mt-10 max-w-2xl border-t border-neutral-800 pt-10">
